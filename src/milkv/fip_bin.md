...
cksum:   0xdeadbeea
size:    0xdeadbeeb
runaddr: 0x0000_0000_8050_0000
```

### xv6-virusvのu-boot-raw.bin

```bash
$ xxd u-boot-raw.bin | head -2
00000000: 05a0 0100 424c 3333 eabe adde ebbe adde  ....BL33........
...
cksum:   0xdeadbeea
size:    0xdeadbeeb
runaddr: 0x0000_0000_8020_0000
```

# fip_binの内容

1. param1のすべてを連結(4096バイト固定)
2. BLCPバイナリ
3. BL2バイナリ
4. param2のすべてを連結(4096バイト固定)
5. DDR_PARAMバイナリ
6. BLCP_2NDバイナリ
7. MONITORバイナリ
8. LOADER_2NDバイナリ
...
```c
struct param1 {
    int8_t magic1[8];     // "CVBL01\n\0
    int32_t magic2;
    int32_t param_chsum:
    uint8_t nand_info[128];
    uint8_t nor_info[36];
    int64_t fip_flags;
    int32_t chip_conf_size;
    int32_t blcp_img_cksum;
    int32_t blcp_img_size;
    int32_t blcp_img_runaddr;
    int32_t blcp_param_loadaddr;
    int32_t blcp_param_size;
    int32_t bl2_img_cksum;
    int32_t bl2_img_size;
    int32_t bld_img_size;
    int32_t param2_loadaddr;
    int32_t reserved1;
...
struct param2 {
    int8_t  magic1[8];
    int32_t param2_cksum;
    int32_t reserved1;
    int32_t ddr_param_cksum;
    int32_t ddr_param_loadaddr;
    int32_t ddr_param_size;
    int32_t ddr_param_reserved;
    int32_t blcp_2nd_cksum;
    int32_t blcp_2nd_loadaddr;
    int32_t blpc_2nd_size;
    int32_t blcp_2nd_runaddr;
    int32_t monitor_cksum;
    int32_t monitor_loadaddr;
    int32_t monitor_size;
    int32_t monitor_runaddr;
    int32_t loader_2nd_reserved;
    int32_t loader_2nd_loadaddr;
    int32_t loader_2nd_reserved1;
    int32_t loader_2nd_reserved2;
    int8_t  reserved_last[4096 - 16 * 5];
}
```
...
class FIP:
    ...
    # BLCPファイルを読み込んでbody1[]に、パラメタをparam1[]にセット
    ...
    # BL2ファイルを読み込んでbody1[]に、パラメタをparam1[]にセット
    ...
    # fip1_bin (BLCP+BL2+param1のバイナリを連結)を作成
    def make_fip1(self):
        ...
        # BLCP_IMG_CKSUM/BLCP_IMG_SIZEのセット
    ...
    def add_loader_2nd(self, args):
        ...
        if magic != LOADER_2ND_MAGIC_ORIG:  # "BL33"
    ...
    def _compress_ldr_2nd(self):
        ...
        if magic == LOADER_2ND_MAGIC_ORIG:
            ...
            if self.compress_algo is None:
                ...
                self.ldr_2nd_hdr["MAGIC"].content = LOADER_2ND_MAGIC_LZMA   // "B3MA"
    ...
    # fip_binのnameの領域にvalueをセットして、chksumを再計算
    ...
    def append_fip2(self, fip1_bin, args):
        ...
        param2_bin = b"".join((entry.content for entry in self.param2.values()))  # cksumを更新
    ...
    def make(self, args=None):
        # fip1_binを作成してfip_binとする
        fip_bin = self.make_fip1()
        # fip2_binを作成してfip_binに連結
